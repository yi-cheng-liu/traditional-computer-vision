...
if __name__ == "__main__":
    ...
    cases = ["eynsham", "florence2", "florence3", "florence3_alt", "lowetag", "mertonchapel", "mertoncourtyard", "vgg", "florida", "huron"]
    ...
    for i in range(8):
        p1 = read_img(os.path.join("task6/huron/", "p1.jpg"))
        p2 = read_img(os.path.join("task6/huron/", "p2.jpg"))
        p3 = read_img(os.path.join("task6/huron/", "p3.jpg"))
        p4 = read_img(os.path.join("task6/huron/", "p4.jpg"))
        p5 = read_img(os.path.join("task6/huron/", "p5.jpg"))
        p6 = read_img(os.path.join("task6/huron/", "p6.jpg"))
        p7 = read_img(os.path.join("task6/huron/", "p7.jpg"))
        p8 = read_img(os.path.join("task6/huron/", "p8.jpg"))
        
        combined_img = make_warped(p1, p2)
        save_img(combined_img, "result/task6/combined_images/huron_1_2_combined.jpg")
        combined_img = make_warped(p3, p4)
        save_img(combined_img, "result/task6/combined_images/huron_3_4_combined.jpg")
        combined_img = make_warped(p5, p6)
        save_img(combined_img, "result/task6/combined_images/huron_5_6_combined.jpg")
        combined_img = make_warped(p7, p8)
        save_img(combined_img, "result/task6/combined_images/huron_7_8_combined.jpg")